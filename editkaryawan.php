...
if (isset($_POST['update'])) {
    ...
    if (is_uploaded_file($_FILES['foto_pribadi']['tmp_name'])) {
        if ($size1 >= 3000000000000) {
            echo "File terlalu besar";
            if (is_uploaded_file($_FILES['foto_ktp']['tmp_name'])) {
                if ($size2 >= 30000000000) {
                    echo "File terlalu besar";
                    if (is_uploaded_file($_FILES['foto_kk']['tmp_name'])) {
                        if ($size3 >= 30000000000) {
                            echo "File terlalu besar";
                        }else {
                            if (move_uploaded_file($_FILES['foto_kk']['tmp_name'],$dir)) {
                            $query = mysqli_query($koneksi,"UPDATE karyawan SET  id='$idk',foto_pribadi='$gambar1', nama='$nama', email='$email', password='$password', jk='$jk', alamat='$alamat', no_hp='$no_hp',foto_ktp='$gambar2',foto_kk='', WHERE id='$idk'");
                        }
                    }
                }else {
                    if (move_uploaded_file($_FILES['foto_ktp']['tmp_name'],$dir)) {
                    $query = mysqli_query($koneksi,"UPDATE karyawan SET  id='$idk',foto_pribadi='$gambar1', nama='$nama', email='$email', password='$password', jk='$jk', alamat='$alamat', no_hp='$no_hp',foto_ktp='',foto_kk='$gambar3', WHERE id='$idk'");
                }
            }
        }else {
            if (move_uploaded_file($_FILES['foto_pribadi']['tmp_name'],$dir)) {
            $query = mysqli_query($koneksi,"UPDATE karyawan SET  id='$idk',foto_pribadi='$gambar1', nama='$nama', email='$email', password='$password', jk='$jk', alamat='$alamat', no_hp='$no_hp',foto_ktp='$gambar2',foto_kk='$gambar3', WHERE id='$idk'");
        }
    }
}  
}   
        ...
        $query = mysqli_query($koneksi,"UPDATE karyawan SET id='$idk',foto_pribadi='', nama='$nama', email='$email', password='$password', jk='$jk', alamat='$alamat', no_hp='$no_hp',foto_ktp='',foto_kk='', WHERE id='$idk'");
...
<div class="container mb-4">
        ...
        <tr>
            ...
            <td>
                <input type="file" name="foto_pribadi" id="">
            </td>
        </tr>
        <tr><br>
        ...
        <tr>
            ...
            <td>
                ...
                if (isset($gambar2)) {
                    ?>
                    <img src="img/ktp/<?= $data['foto_ktp']?>" alt="" width="120px" height="120px">
                <?php
                }
                ?>
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="file" name="foto_ktp" id="">
            </td>
        </tr>
        <tr><br>
            <td>KK</td>
            <td>
                ...
                if (isset($gambar3)) {
                    ?>
                    <img src="img/kk/<?= $data['foto_kk']?>" alt="" width="120px" height="120px">
                <?php
                }
                ?>
            </td>
        ...
        <tr>
            ...
            <td>
                <input type="file" name="foto_kk" id="">
            </td>
        </tr>
        <tr>
